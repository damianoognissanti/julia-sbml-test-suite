# Model name: 00024_sbml_l2v1
# Number of parameters: 5
# Number of species: 4
function getODEModel_00024_sbml_l2v1()
    ...
    D(S3) ~ 0.0,
    D(S2) ~ +1 * ( 1 /compartment ) * (((compartment*k4)*S3)*S4)+1 * ( 1 /compartment ) * ((compartment*k1)*S1)-1 * ( 1 /compartment ) * ((compartment*k2)*S2)-1 * ( 1 /compartment ) * ((compartment*k3)*S2)
    ]
