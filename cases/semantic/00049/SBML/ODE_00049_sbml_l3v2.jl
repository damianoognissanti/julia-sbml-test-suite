# Model name: 00049_sbml_l3v2
# Number of parameters: 3
# Number of species: 3
function getODEModel_00049_sbml_l3v2()
    ...
    D(S3) ~ +1.0 * ( 1 /compartment ) * ((k1*S1)*S2)-1.0 * ( 1 /compartment ) * (k2*S3),
    D(S2) ~ -1.0 * ( 1 /compartment ) * ((k1*S1)*S2)+1.0 * ( 1 /compartment ) * (k2*S3)
    ]
