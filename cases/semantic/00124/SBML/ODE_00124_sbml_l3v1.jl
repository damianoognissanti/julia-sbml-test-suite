# Model name: 00124_sbml_l3v1
# Number of parameters: 5
# Number of species: 4
function getODEModel_00124_sbml_l3v1()
    ...
    ### Define parameters
    ModelingToolkit.@parameters compartment k3 p2 p1 k2 

    ### Store parameters in array for ODESystem command
    parameterArray = [compartment, k3, p2, p1, k2]
    ...
    ### Derivatives ###
    eqs = [
    D(S1) ~ -1.0 * ( 1 /compartment ) * (((compartment*k1)*S1)*S2)+1.0 * ( 1 /compartment ) * ((compartment*k2)*S3),
