# Model name: 00167_sbml_l1v2
# Number of parameters: 5
# Number of species: 4
function getODEModel_00167_sbml_l1v2()
    ...
    ### Define parameters
    ModelingToolkit.@parameters AssignedName k3 k4 k1 k2 

    ### Store parameters in array for ODESystem command
    parameterArray = [AssignedName, k3, k4, k1, k2]
